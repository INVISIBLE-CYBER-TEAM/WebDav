...
def webdav():
  ...
  if r.status_code < 200 or r.status_code >= 300:
    ...
    print("[+]InvisibleCyberTeam")
    print("[+]Edited By MR.3")
...
────█▌▀▄──▄▄──▄▀▐█──
───▐██──▀▀──▀▀──██▌──
──▄████▄──▐▌──▄████▄─꧁I͓̽C͓̽T͓̽ ͓̽W͓̽E͓̽B͓̽.͓̽D͓̽A͓̽V͓̽꧂
""")
...
if __name__ == '__main__':
  if len(sys.argv) != 3:
    ...
    print("\n[*] Example : python2 webdav.py http://inlislite.perpusnas.go.id Deface.py")
    sys.exit(0)
  else:
    cekfile()
